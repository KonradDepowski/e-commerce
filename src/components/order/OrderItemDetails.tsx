    ...
    >
      <div className="flex justify-center ">
        ...
        <div className="flex flex-col justify-center items-center w-[60%]">
          <h5 className="text-md text-[#59ab6e] text-center py-1 xl:text-lg 2xl:text-xl">
            {name}
          </h5>
          <p>
            <span className="2xl:text-md">Size:</span>{" "}
      ...
      <div className="flex justify-around py-3">
        <p>
          <span className="2xl:text-md">Price:</span>{" "}
          <span className="text-gray-600 2xl:text-md">${price}</span>
        </p>
        <p>
          <span className="2xl:text-md">Quntity:</span>{" "}
          <span className="text-gray-600 2xl:text-md">{quantity}</span>
        </p>
        <p>
          <span className="2xl:text-md">Total:</span>{" "}
